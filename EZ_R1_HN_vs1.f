! program to calculate selective and unslective R1 relaxation rates  of amide protons (HN or H ) from a pdb file
...
!!! start program
 ...
 21	print 1
 1	format(' pdb file using HN as atom name for amide protons > ', $)
	read(*,2) pdbname
 2	format(a)	
...
! MASTERLOOP over all protons in the pdb file
 ...
 1000	read(unit=40,fmt=2,err=1002, end=1002 )line
	...
	1	occ, Bfact, ID, charge
 	...
 	if(atname(2:3).eq.'HN'.or.atname(2:3).eq.'H ') then
